...
const elementCloneForm = elementSearch.cloneNode(true) ; 
...
window.addEventListener('scroll' , functionResize)
 ...
 function functionResize(e) {
  ...
  if (Width <= 1280) {
     ...
     functionehead( elementItemMenu.after(elementLogo)  , headerContent.append(elementContact), elementForm.insertBefore(elementCloneForm , elementInsertBeforeForm)  , elementContact.classList.add('top-header__columns') )   
      : 
